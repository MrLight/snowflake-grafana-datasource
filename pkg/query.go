...
func (td *SnowflakeDatasource) query(ctx context.Context, wg *sync.WaitGroup, ch chan DBDataResponse, instance *instanceSettings, dataQuery backend.DataQuery) {
	...
	queryConfig := queryConfigStruct{
		...
		CacheState:    cacheState{Use: true, Until: time.Unix(0, 0)},
		db:            instance.db,
...
func (td *SnowflakeDatasource) querySQL(ctx context.Context, queryConfig queryConfigStruct, dataQuery backend.DataQuery) *data.Frame {
